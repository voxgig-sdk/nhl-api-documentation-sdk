...
const testSeed = `map[string]any{"entity": map[string]any{"conference": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "division": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "game": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "player_stat": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "roster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "standing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
