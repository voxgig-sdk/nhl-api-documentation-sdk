...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("NHLAPIDOCUMENTATION_TEST_LIVE") == "TRUE" ||
		os.Getenv("NHLAPIDOCUMENTATION_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("NHLAPIDOCUMENTATION_TEST_EXPLAIN"); explain != "" {
