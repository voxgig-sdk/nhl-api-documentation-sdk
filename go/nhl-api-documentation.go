...
// instead of `sdk.NewNhlApiDocumentationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NhlApiDocumentationSDK  { return NewNhlApiDocumentationSDK(nil) }
func Test() *NhlApiDocumentationSDK { return TestSDK(nil, nil) }
