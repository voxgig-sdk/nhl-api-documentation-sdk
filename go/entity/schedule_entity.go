...
func NewScheduleEntity(client *core.NhlApiDocumentationSDK, entopts map[string]any) *ScheduleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScheduleEntity) GetName() string { return e.name }
...
func (e *ScheduleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ScheduleEntity) Deleted() bool {
	return e.deleted
}


func (e *ScheduleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewScheduleEntity(e.client, opts)
}

func (e *ScheduleEntity) Data(args ...any) any {
...
func (e *ScheduleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Schedule; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ScheduleEntity) DataTyped(data ...Schedule) Schedule {
	if len(data) > 0 {
		return typedFrom[Schedule](e.Data(asMap(data[0])))
	}
	return typedFrom[Schedule](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Schedule (all fields
// optional at the wire level).
func (e *ScheduleEntity) MatchTyped(match ...Schedule) Schedule {
	if len(match) > 0 {
		return typedFrom[Schedule](e.Match(asMap(match[0])))
	}
	return typedFrom[Schedule](e.Match())
}
...
func (e *ScheduleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ScheduleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ScheduleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ScheduleListMatch and returns []Schedule. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ScheduleEntity) ListTyped(reqmatch ScheduleListMatch, ctrl map[string]any) ([]Schedule, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Schedule](res), nil
}



func (e *ScheduleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ScheduleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ScheduleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ScheduleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
