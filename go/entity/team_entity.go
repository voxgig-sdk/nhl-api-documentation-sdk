...
func NewTeamEntity(client *core.NhlApiDocumentationSDK, entopts map[string]any) *TeamEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TeamEntity) GetName() string { return e.name }
...
func (e *TeamEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TeamEntity) Deleted() bool {
	return e.deleted
}


func (e *TeamEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTeamEntity(e.client, opts)
}

func (e *TeamEntity) Data(args ...any) any {
...
func (e *TeamEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TeamEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TeamEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
