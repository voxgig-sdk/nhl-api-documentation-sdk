...
func NewDivisionEntity(client *core.NhlApiDocumentationSDK, entopts map[string]any) *DivisionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DivisionEntity) GetName() string { return e.name }
...
func (e *DivisionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DivisionEntity) Deleted() bool {
	return e.deleted
}


func (e *DivisionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDivisionEntity(e.client, opts)
}

func (e *DivisionEntity) Data(args ...any) any {
...
func (e *DivisionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Division; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DivisionEntity) DataTyped(data ...Division) Division {
	if len(data) > 0 {
		return typedFrom[Division](e.Data(asMap(data[0])))
	}
	return typedFrom[Division](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Division (all fields
// optional at the wire level).
func (e *DivisionEntity) MatchTyped(match ...Division) Division {
	if len(match) > 0 {
		return typedFrom[Division](e.Match(asMap(match[0])))
	}
	return typedFrom[Division](e.Match())
}
...
func (e *DivisionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DivisionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DivisionLoadMatch and returns an Division. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DivisionEntity) LoadTyped(reqmatch DivisionLoadMatch, ctrl map[string]any) (Division, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Division{}, err
	}
	return typedFrom[Division](res), nil
}




func (e *DivisionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// DivisionListMatch and returns []Division. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DivisionEntity) ListTyped(reqmatch DivisionListMatch, ctrl map[string]any) ([]Division, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Division](res), nil
}



func (e *DivisionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DivisionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DivisionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DivisionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
