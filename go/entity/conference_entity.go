...
func NewConferenceEntity(client *core.NhlApiDocumentationSDK, entopts map[string]any) *ConferenceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConferenceEntity) GetName() string { return e.name }
...
func (e *ConferenceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConferenceEntity) Deleted() bool {
	return e.deleted
}


func (e *ConferenceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConferenceEntity(e.client, opts)
}

func (e *ConferenceEntity) Data(args ...any) any {
...
func (e *ConferenceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ConferenceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConferenceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *ConferenceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConferenceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConferenceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConferenceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
