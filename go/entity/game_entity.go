...
func NewGameEntity(client *core.NhlApiDocumentationSDK, entopts map[string]any) *GameEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GameEntity) GetName() string { return e.name }
...
func (e *GameEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GameEntity) Deleted() bool {
	return e.deleted
}


func (e *GameEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGameEntity(e.client, opts)
}

func (e *GameEntity) Data(args ...any) any {
...
func (e *GameEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Game; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GameEntity) DataTyped(data ...Game) Game {
	if len(data) > 0 {
		return typedFrom[Game](e.Data(asMap(data[0])))
	}
	return typedFrom[Game](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Game (all fields
// optional at the wire level).
func (e *GameEntity) MatchTyped(match ...Game) Game {
	if len(match) > 0 {
		return typedFrom[Game](e.Match(asMap(match[0])))
	}
	return typedFrom[Game](e.Match())
}
...
func (e *GameEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GameEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GameLoadMatch and returns an Game. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GameEntity) LoadTyped(reqmatch GameLoadMatch, ctrl map[string]any) (Game, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Game{}, err
	}
	return typedFrom[Game](res), nil
}



func (e *GameEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GameEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GameEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GameEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GameEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
