...
func NewRosterEntity(client *core.NhlApiDocumentationSDK, entopts map[string]any) *RosterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RosterEntity) GetName() string { return e.name }
...
func (e *RosterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RosterEntity) Deleted() bool {
	return e.deleted
}


func (e *RosterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRosterEntity(e.client, opts)
}

func (e *RosterEntity) Data(args ...any) any {
...
func (e *RosterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Roster; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RosterEntity) DataTyped(data ...Roster) Roster {
	if len(data) > 0 {
		return typedFrom[Roster](e.Data(asMap(data[0])))
	}
	return typedFrom[Roster](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Roster (all fields
// optional at the wire level).
func (e *RosterEntity) MatchTyped(match ...Roster) Roster {
	if len(match) > 0 {
		return typedFrom[Roster](e.Match(asMap(match[0])))
	}
	return typedFrom[Roster](e.Match())
}
...
func (e *RosterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RosterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RosterEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RosterListMatch and returns []Roster. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RosterEntity) ListTyped(reqmatch RosterListMatch, ctrl map[string]any) ([]Roster, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Roster](res), nil
}



func (e *RosterEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RosterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RosterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RosterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
