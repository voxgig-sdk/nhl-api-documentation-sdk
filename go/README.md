...
## Install
```bash
go get github.com/voxgig-sdk/nhl-api-documentation-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/nhl-api-documentation-sdk=../path/to/github.com/voxgig-sdk/nhl-api-documentation-sdk
```
...
```
github.com/voxgig-sdk/nhl-api-documentation-sdk/
...
The root package (`github.com/voxgig-sdk/nhl-api-documentation-sdk`) re-exports everything needed
