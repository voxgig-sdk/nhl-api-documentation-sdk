...
class ConferenceEntity extends NhlApiDocumentationEntityBase<Conference> {
  ...
  make(this: ConferenceEntity) {
    return new ConferenceEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ConferenceLoadMatch, ctrl?: Control): Promise<ConferenceEntity> {
  ...
  async list(this: any, reqmatch?: ConferenceListMatch, ctrl?: Control): Promise<ConferenceEntity[]> {
