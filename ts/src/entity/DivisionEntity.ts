...
class DivisionEntity extends NhlApiDocumentationEntityBase<Division> {
  ...
  make(this: DivisionEntity) {
    return new DivisionEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: DivisionLoadMatch, ctrl?: Control): Promise<DivisionEntity> {
  ...
  async list(this: any, reqmatch?: DivisionListMatch, ctrl?: Control): Promise<DivisionEntity[]> {
