...
(0, node_test_1.describe)('RosterDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-roster', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-roster', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NHL_API_DOCUMENTATION_TEST_ROSTER_ENTID'];
...
//# sourceMappingURL=RosterDirect.test.js.map