...
(0, node_test_1.describe)('DivisionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-division', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-division', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-division', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-division', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NHL_API_DOCUMENTATION_TEST_DIVISION_ENTID'];
...
//# sourceMappingURL=DivisionDirect.test.js.map