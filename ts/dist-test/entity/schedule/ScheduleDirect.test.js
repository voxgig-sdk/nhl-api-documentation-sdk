...
(0, node_test_1.describe)('ScheduleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-schedule', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-schedule', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NHL_API_DOCUMENTATION_TEST_SCHEDULE_ENTID'];
...
//# sourceMappingURL=ScheduleDirect.test.js.map