...
(0, node_test_1.describe)('PlayerStatDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-player_stat', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-player_stat', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["person01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NHL_API_DOCUMENTATION_TEST_PLAYER_STAT_ENTID'];
...
//# sourceMappingURL=PlayerStatDirect.test.js.map