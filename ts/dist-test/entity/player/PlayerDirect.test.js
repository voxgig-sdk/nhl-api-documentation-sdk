...
(0, node_test_1.describe)('PlayerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-player', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-player', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NHL_API_DOCUMENTATION_TEST_PLAYER_ENTID'];
...
//# sourceMappingURL=PlayerDirect.test.js.map