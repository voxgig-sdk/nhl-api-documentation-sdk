...
(0, node_test_1.describe)('ConferenceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NhlApiDocumentationSDK({
    ...
    (0, node_test_1.test)('direct-load-conference', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-conference', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-conference', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conference', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NhlApiDocumentationSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['NHL_API_DOCUMENTATION_TEST_CONFERENCE_ENTID'];
    ...
    const client = new __1.NhlApiDocumentationSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ConferenceDirect.test.js.map