...
(0, node_test_1.describe)('StandingEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'standing.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    let idmap = transform(['standing01', 'standing02', 'standing03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['NHL_API_DOCUMENTATION_TEST_STANDING_ENTID'];
    ...
    idmap = env['NHL_API_DOCUMENTATION_TEST_STANDING_ENTID'];
