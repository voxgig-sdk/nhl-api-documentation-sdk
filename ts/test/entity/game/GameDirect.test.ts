...
describe('GameDirect', async () => {
  ...
  test('direct-load-game', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-game', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['NHL_API_DOCUMENTATION_TEST_GAME_ENTID']
