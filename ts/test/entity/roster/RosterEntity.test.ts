...
describe('RosterEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'roster.' + op, live)) return
    }
    ...
    let roster_ref01_data = Object.values(setup.data.existing.roster)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/roster/RosterTestData.json')
