...
describe('ScheduleDirect', async () => {
  ...
  test('direct-list-schedule', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-schedule', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['NHL_API_DOCUMENTATION_TEST_SCHEDULE_ENTID']
