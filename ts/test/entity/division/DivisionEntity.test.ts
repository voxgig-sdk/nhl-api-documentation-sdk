...
describe('DivisionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list', 'load']) {
      if (maybeSkipControl(t, 'entityOp', 'division.' + op, live)) return
    }
    ...
    let division_ref01_data = Object.values(setup.data.existing.division)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/division/DivisionTestData.json')
