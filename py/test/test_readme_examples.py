# NhlApiDocumentation SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from nhlapidocumentation_sdk import NhlApiDocumentationSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"NhlApiDocumentationSDK": NhlApiDocumentationSDK, "os": os}
        try:
