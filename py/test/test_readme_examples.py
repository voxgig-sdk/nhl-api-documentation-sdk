# NhlApiDocumentation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NhlApiDocumentationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NhlApiDocumentationSDK(...) and NhlApiDocumentationSDK.test(...) become
#      NhlApiDocumentationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nhlapidocumentation_sdk"
_SDK_CLASS = "NhlApiDocumentationSDK"
