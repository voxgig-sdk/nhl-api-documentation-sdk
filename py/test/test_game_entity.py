    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set NHL_API_DOCUMENTATION_TEST_GAME_ENTID JSON to run live")
        client = setup["client"]
        ...
        game_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(game_ref01_data_dt0_loaded))
...
def _game_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("NHL_API_DOCUMENTATION_TEST_GAME_ENTID"))
