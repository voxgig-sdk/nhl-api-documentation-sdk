...
from nhlapidocumentation_sdk.core.control import NhlApiDocumentationControl
...
from nhlapidocumentation_sdk.core.helpers import get_ctx_prop, to_map
...
class NhlApiDocumentationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NhlApiDocumentationControl()
        ...
        if isinstance(sp, NhlApiDocumentationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NhlApiDocumentationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NhlApiDocumentationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NhlApiDocumentationOperation({})
    ...
    def make_error(self, code, msg):
        return NhlApiDocumentationError(code, msg, self)
