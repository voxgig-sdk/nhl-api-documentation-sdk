...
from nhlapidocumentation_sdk.utility import register

# Load features
from nhlapidocumentation_sdk.feature.base_feature import NhlApiDocumentationBaseFeature
from nhlapidocumentation_sdk.features import _has_feature, _make_feature
...
class NhlApiDocumentationSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "NhlApiDocumentationSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NhlApiDocumentationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Conference(self, data=None) -> "ConferenceEntity":
        ...
        from nhlapidocumentation_sdk.entity.conference_entity import ConferenceEntity
    ...
    def PlayerStat(self, data=None) -> "PlayerStatEntity":
        ...
        from nhlapidocumentation_sdk.entity.player_stat_entity import PlayerStatEntity
    ...
    def Roster(self, data=None) -> "RosterEntity":
        ...
        from nhlapidocumentation_sdk.entity.roster_entity import RosterEntity
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from nhlapidocumentation_sdk.entity.schedule_entity import ScheduleEntity
    ...
    def Standing(self, data=None) -> "StandingEntity":
        ...
        from nhlapidocumentation_sdk.entity.standing_entity import StandingEntity
        return StandingEntity(self, data)


    def Team(self, data=None) -> "TeamEntity":
        """Entity factory: client.Team().list() / client.Team().load({"id": ...})."""
        from nhlapidocumentation_sdk.entity.team_entity import TeamEntity
