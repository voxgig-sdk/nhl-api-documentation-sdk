...
describe("StandingDirect", function()
  it("should direct-list-standing", function()
    local setup = standing_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-standing", setup.live and "live" or "unit")
...
function standing_direct_setup(mockres)
