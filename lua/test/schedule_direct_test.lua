...
describe("ScheduleDirect", function()
  it("should direct-list-schedule", function()
    local setup = schedule_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-schedule", setup.live and "live" or "unit")
...
function schedule_direct_setup(mockres)
