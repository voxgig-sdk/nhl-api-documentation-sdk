...
describe("TeamEntity", function()
  ...
  it("should stream", function()
    ...
    local seen = {}
    for item in base:Team(nil):stream("list", nil, nil) do
    ...
    if type(config.feature) == "table" and config.feature.streaming ~= nil then
      ...
      local got = {}
      for item in streamsdk:Team(nil):stream("list", nil, nil) do
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set NHL_API_DOCUMENTATION_TEST_TEAM_ENTID JSON to run live")
      return
    end
...
function team_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("NHL_API_DOCUMENTATION_TEST_TEAM_ENTID")
