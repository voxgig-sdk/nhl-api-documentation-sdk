...
local SDK_MODULE = "nhl-api-documentation_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["conference"] = { ["test01"] = { id = "test01" } }, ["division"] = { ["test01"] = { id = "test01" } }, ["game"] = { ["test01"] = { id = "test01" } }, ["player"] = { ["test01"] = { id = "test01" } }, ["player_stat"] = { ["test01"] = { id = "test01" } }, ["roster"] = { ["test01"] = { id = "test01" } }, ["schedule"] = { ["test01"] = { id = "test01" } }, ["standing"] = { ["test01"] = { id = "test01" } }, ["team"] = { ["test01"] = { id = "test01" } } } }'
