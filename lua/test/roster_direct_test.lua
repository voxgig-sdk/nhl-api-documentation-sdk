...
describe("RosterDirect", function()
  it("should direct-list-roster", function()
    local setup = roster_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-roster", setup.live and "live" or "unit")
...
function roster_direct_setup(mockres)
