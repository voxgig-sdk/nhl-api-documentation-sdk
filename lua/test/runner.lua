...
function runner.env_override(m)
  local live = runner.getenv("NHLAPIDOCUMENTATION_TEST_LIVE")
  local override = runner.getenv("NHLAPIDOCUMENTATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NHLAPIDOCUMENTATION_TEST_EXPLAIN")
