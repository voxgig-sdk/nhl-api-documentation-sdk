// Command NhlApiDocumentation-mcp is an MCP server exposing the NhlApiDocumentation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NhlApiDocumentation_list  — list records of an entity
//	NhlApiDocumentation_load  — load a single record of an entity
//
