...
class ScheduleEntity
  ...
  def make
    opts = @_entopts.dup
    ScheduleEntity.new(@_client, opts)
  end
  ...
  # @return [Schedule, Hash] the current Schedule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Schedule fields)
  def match_get
  ...
  #
  # @param reqmatch [ScheduleListMatch, Hash, nil] match filter (any subset of
  #   Schedule fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Schedule>, Array] the matching Schedule items; raises NhlApiDocumentationError on failure
