...
class StandingEntity
  ...
  def make
    opts = @_entopts.dup
    StandingEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [StandingListMatch, Hash, nil] match filter (any subset of
  #   Standing fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Standing>, Array] the matching Standing items; raises NhlApiDocumentationError on failure
