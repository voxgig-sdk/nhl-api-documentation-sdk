...
class PlayerStatEntity
  ...
  def make
    opts = @_entopts.dup
    PlayerStatEntity.new(@_client, opts)
  end
  ...
  # @return [PlayerStat, Hash] the current PlayerStat data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PlayerStat fields)
  def match_get
  ...
  #
  # @param reqmatch [PlayerStatListMatch, Hash, nil] match filter (any subset of
  #   PlayerStat fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<PlayerStat>, Array] the matching PlayerStat items; raises NhlApiDocumentationError on failure
