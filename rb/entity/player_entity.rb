...
class PlayerEntity
  ...
  # @return [Player, Hash] the current Player data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Player fields)
  def match_get
  ...
  #
  # @param reqmatch [PlayerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Player.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Player, Hash] the loaded Player; raises NhlApiDocumentationError on failure
