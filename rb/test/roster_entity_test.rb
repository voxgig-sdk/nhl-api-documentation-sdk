...
class RosterEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NHL_API_DOCUMENTATION_TEST_ROSTER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def roster_basic_setup(extra)
  ...
  entid_env_raw = ENV["NHL_API_DOCUMENTATION_TEST_ROSTER_ENTID"]
