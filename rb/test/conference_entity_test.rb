...
class ConferenceEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set NHLAPIDOCUMENTATION_TEST_CONFERENCE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def conference_basic_setup(extra)
  ...
  entid_env_raw = ENV["NHLAPIDOCUMENTATION_TEST_CONFERENCE_ENTID"]
