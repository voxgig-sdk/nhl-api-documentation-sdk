...
#      offline in seeded test mode (NhlApiDocumentationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NhlApiDocumentation_sdk.rb")
  SDK_CLASS = "NhlApiDocumentationSDK"
  ...
  SDK_BASE = "NhlApiDocumentation_sdk"
