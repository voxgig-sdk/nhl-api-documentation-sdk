...
// NhlApiDocumentation SDK utility type

class NhlApiDocumentationUtility
{
    ...
    public static function copy(NhlApiDocumentationUtility $src): NhlApiDocumentationUtility
    {
        $u = new NhlApiDocumentationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
