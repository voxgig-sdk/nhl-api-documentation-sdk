...
// NhlApiDocumentation SDK pipeline test
//
...
{
    private static function utility(): NhlApiDocumentationUtility
    {
        return new NhlApiDocumentationUtility();
    }
    ...
    private static function ctx(array $over = []): NhlApiDocumentationContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NhlApiDocumentationContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NhlApiDocumentationOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NhlApiDocumentationError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NhlApiDocumentationOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NhlApiDocumentationMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NhlApiDocumentationOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NhlApiDocumentationMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NhlApiDocumentationOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NhlApiDocumentationMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NhlApiDocumentationSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NhlApiDocumentationMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NhlApiDocumentationResponse([]),
            'result' => new NhlApiDocumentationResult([]),
        ]);
        [, $err] = NhlApiDocumentationMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NhlApiDocumentationSpec([]),
            'response' => null,
            'result' => new NhlApiDocumentationResult([]),
        ]);
        [, $err] = NhlApiDocumentationMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NhlApiDocumentationSpec(['step' => 's']),
            'response' => new NhlApiDocumentationResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NhlApiDocumentationResult([]),
        ]);
        [, $err] = NhlApiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NhlApiDocumentationSpec(['step' => 's']),
            'response' => new NhlApiDocumentationResponse(self::resp(200, ['v' => 1])),
            'result' => new NhlApiDocumentationResult([]),
        ]);
        [, $err] = NhlApiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NhlApiDocumentationSpec(['step' => 's']),
            'response' => new NhlApiDocumentationResponse(self::resp(200, ['v' => 2])),
            'result' => new NhlApiDocumentationResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NhlApiDocumentationMakeResponse::call($ctx);
    ...
    {
        $preset = new NhlApiDocumentationResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NhlApiDocumentationSpec([]),
            'response' => new NhlApiDocumentationResponse([]),
            'result' => new NhlApiDocumentationResult([]),
        ...
        [$got, $err] = NhlApiDocumentationMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NhlApiDocumentationResult([])]);
        [, $err] = NhlApiDocumentationMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NhlApiDocumentationSpec([]), 'result' => null]);
        [, $err] = NhlApiDocumentationMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NhlApiDocumentationSpec(['step' => 's']),
            'result' => new NhlApiDocumentationResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NhlApiDocumentationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NhlApiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NhlApiDocumentationSpec(['step' => 's']),
            'result' => new NhlApiDocumentationResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NhlApiDocumentationOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NhlApiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NhlApiDocumentationResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NhlApiDocumentationSpec([]),
            'result' => new NhlApiDocumentationResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NhlApiDocumentationMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NhlApiDocumentationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NhlApiDocumentationError('boom', 'boom');
        $utility->fetcher = function (NhlApiDocumentationContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NhlApiDocumentationSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NhlApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NhlApiDocumentationContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NhlApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NhlApiDocumentationResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NhlApiDocumentationMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NhlApiDocumentationContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NhlApiDocumentationSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NhlApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NhlApiDocumentationResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NhlApiDocumentationSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NhlApiDocumentationMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NhlApiDocumentationMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NhlApiDocumentationMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NhlApiDocumentationResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NhlApiDocumentationDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NhlApiDocumentationResult(['ok' => false])]);
        $this->expectException(NhlApiDocumentationError::class);
        NhlApiDocumentationDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NhlApiDocumentationResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NhlApiDocumentationMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NhlApiDocumentationMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NhlApiDocumentationBaseFeature();
        $b = new NhlApiDocumentationBaseFeature();
        NhlApiDocumentationFeatureAdd::call($ctx, $a);
        NhlApiDocumentationFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NhlApiDocumentationBaseFeature
    {
        $f = new NhlApiDocumentationBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NhlApiDocumentationFeatureAdd::call($ctx, self::named_feature('a'));
        NhlApiDocumentationFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        NhlApiDocumentationFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        NhlApiDocumentationFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        NhlApiDocumentationFeatureAdd::call($ctx, $replace);
        ...
        NhlApiDocumentationFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NhlApiDocumentationContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NhlApiDocumentationSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NhlApiDocumentationPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NhlApiDocumentationPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NhlApiDocumentationResponse(['headers' => null]),
            'result' => new NhlApiDocumentationResult([]),
        ]);
        NhlApiDocumentationResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NhlApiDocumentationResultBody::call($ctx);
