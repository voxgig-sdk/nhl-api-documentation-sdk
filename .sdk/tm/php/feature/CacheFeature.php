...
// NhlApiDocumentation SDK cache feature
...
class NhlApiDocumentationCacheFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _through(NhlApiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
