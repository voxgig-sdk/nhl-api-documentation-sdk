...
// NhlApiDocumentation SDK rbac feature
...
class NhlApiDocumentationRbacFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _required(NhlApiDocumentationContext $ctx): ?string
    {
    ...
    private function _reject(NhlApiDocumentationContext $ctx, string $required): void
    {
    ...
    private function _track(NhlApiDocumentationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
