...
// NhlApiDocumentation SDK audit feature
...
class NhlApiDocumentationAuditFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _emit(NhlApiDocumentationContext $ctx, string $outcome): void
    {
