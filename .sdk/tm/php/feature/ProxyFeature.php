...
// NhlApiDocumentation SDK proxy feature
...
class NhlApiDocumentationProxyFeature extends NhlApiDocumentationBaseFeature
{
    ...
    public function init(NhlApiDocumentationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NhlApiDocumentationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
