...
// NhlApiDocumentation SDK metrics feature
...
class NhlApiDocumentationMetricsFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _record(NhlApiDocumentationContext $ctx, bool $ok): void
    {
