...
// NhlApiDocumentation SDK streaming feature
...
class NhlApiDocumentationStreamingFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _iterate(NhlApiDocumentationResult $result): \Generator
    {
    ...
    private function _streamable(NhlApiDocumentationContext $ctx): bool
    {
