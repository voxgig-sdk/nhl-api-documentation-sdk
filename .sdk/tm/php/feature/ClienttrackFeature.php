...
// NhlApiDocumentation SDK clienttrack feature
...
class NhlApiDocumentationClienttrackFeature extends NhlApiDocumentationBaseFeature
{
    ...
    public function PostConstruct(NhlApiDocumentationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NhlApiDocumentation-SDK';
