...
// NhlApiDocumentation SDK telemetry feature
...
class NhlApiDocumentationTelemetryFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _close(NhlApiDocumentationContext $ctx, bool $ok): void
    {
