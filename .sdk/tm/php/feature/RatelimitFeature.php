...
// NhlApiDocumentation SDK ratelimit feature
...
class NhlApiDocumentationRatelimitFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _acquire(NhlApiDocumentationContext $ctx): void
    {
    ...
    private function _track(NhlApiDocumentationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
