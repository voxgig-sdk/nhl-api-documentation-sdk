...
// NhlApiDocumentation SDK idempotency feature
...
class NhlApiDocumentationIdempotencyFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _mutating(NhlApiDocumentationContext $ctx): bool
    {
