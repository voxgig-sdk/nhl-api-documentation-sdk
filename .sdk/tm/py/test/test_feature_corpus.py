# NhlApiDocumentation SDK feature corpus test
#
...
def _client(kase):
    ...
    NhlApiDocumentationSDK(...), not NhlApiDocumentationSDK.test(...): the `test` feature is
    ...
    return NhlApiDocumentationSDK(opts)
