...
|---|---|---|
| `ts/` | @voxgig-sdk/nhl-api-documentation-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nhl-api-documentation-sdk \
      --repository voxgig-sdk/nhl-api-documentation-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nhl-api-documentation-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nhl-api-documentation-sdk --id=<id>` removes it.
