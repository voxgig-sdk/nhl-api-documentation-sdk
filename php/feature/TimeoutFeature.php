...
// NhlApiDocumentation SDK timeout feature
...
class NhlApiDocumentationTimeoutFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _with_timeout(NhlApiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NhlApiDocumentationContext $_ctx, float $ms): void
    {
        $client = $this->client;
