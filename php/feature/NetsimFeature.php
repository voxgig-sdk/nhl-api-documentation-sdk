...
// NhlApiDocumentation SDK netsim feature
...
class NhlApiDocumentationNetsimFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _simulate(NhlApiDocumentationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NhlApiDocumentationContext $ctx, array $applied): void
    {
        $client = $this->client;
