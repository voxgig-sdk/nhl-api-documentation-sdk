...
// NhlApiDocumentation SDK debug feature
...
class NhlApiDocumentationDebugFeature extends NhlApiDocumentationBaseFeature
{
    ...
    private function _finish(NhlApiDocumentationContext $ctx, bool $ok): void
    {
