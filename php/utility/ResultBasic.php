...
// NhlApiDocumentation SDK utility: result_basic

class NhlApiDocumentationResultBasic
{
    public static function call(NhlApiDocumentationContext $ctx): ?NhlApiDocumentationResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof NhlApiDocumentationError) ? $result->err->msg : (string)$result->err;
