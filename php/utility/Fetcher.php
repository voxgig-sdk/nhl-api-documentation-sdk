...
// NhlApiDocumentation SDK utility: fetcher

class NhlApiDocumentationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NhlApiDocumentationSDK/1.0)';
    ...
    public static function call(NhlApiDocumentationContext $ctx, string $fullurl, array $fetchdef): array
    {
