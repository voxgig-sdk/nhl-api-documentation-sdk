...
// NhlApiDocumentation SDK utility: graphql
//
...
class NhlApiDocumentationGraphql
{
    ...
    // equivalent.
    public static function body(NhlApiDocumentationContext $ctx): mixed
    {
    ...
    public static function errors(NhlApiDocumentationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
