...
// NhlApiDocumentation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NhlApiDocumentationMakeRequest
{
    public static function call(NhlApiDocumentationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NhlApiDocumentationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NhlApiDocumentationResponse($fetched);
        } else {
