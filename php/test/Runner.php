...
class NhlApiDocumentationTestRunner
{
    ...
    {
        $live = self::getenv('NHL_API_DOCUMENTATION_TEST_LIVE');
        $override = self::getenv('NHL_API_DOCUMENTATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NHL_API_DOCUMENTATION_TEST_EXPLAIN');
...
class_alias('NhlApiDocumentationTestRunner', 'Runner');
class_alias('NhlApiDocumentationHelpers', 'Helpers');
