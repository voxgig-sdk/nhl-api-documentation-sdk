...
class NhlApiDocumentationTestRunner
{
    ...
    {
        $live = self::getenv('NHLAPIDOCUMENTATION_TEST_LIVE');
        $override = self::getenv('NHLAPIDOCUMENTATION_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NHLAPIDOCUMENTATION_TEST_EXPLAIN');
