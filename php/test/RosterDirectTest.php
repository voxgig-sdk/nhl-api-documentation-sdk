...
class RosterDirectTest extends TestCase
{
    public function test_direct_list_roster(): void
    {
        $setup = roster_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-roster", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
