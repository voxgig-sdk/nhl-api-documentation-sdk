...
class StandingEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NHL_API_DOCUMENTATION_TEST_STANDING_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function standing_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NHL_API_DOCUMENTATION_TEST_STANDING_ENTID");
