...
class ConferenceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        [$conference_ref01_list_result, $err] = $conference_ref01_ent->list($conference_ref01_match, null);
        $this->assertNull($err);
        ...
        [$conference_ref01_data_dt0_loaded, $err] = $conference_ref01_ent->load($conference_ref01_match_dt0, null);
        $this->assertNull($err);
