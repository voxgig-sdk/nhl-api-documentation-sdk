...
// NhlApiDocumentation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NhlApiDocumentationSDK::test)
...
{
    private const SDK_CLASS = 'NhlApiDocumentationSDK';
    ...
    private const SDK_BASE = 'nhlapidocumentation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nhlapidocumentation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
