...
class ScheduleDirectTest extends TestCase
{
    public function test_direct_list_schedule(): void
    {
        $setup = schedule_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-schedule", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
