...
class PlayerDirectTest extends TestCase
{
    public function test_direct_load_player(): void
    {
        $setup = player_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-player", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
