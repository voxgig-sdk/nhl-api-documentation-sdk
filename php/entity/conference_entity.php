...
// NhlApiDocumentation SDK Conference entity
...
class ConferenceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConferenceEntity($this->_client, $opts);
    }

    /**
     * @param Conference|array $args Conference data (assoc-array) to store.
     */
    ...
    /**
     * @return Conference|array The current Conference data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Conference fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Conference fields).
     */
     ...
     *
     * @param ConferenceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConferenceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conference|array The loaded Conference as an assoc-array at the
     ...
     *
     * @param ConferenceListMatch|array|null $reqmatch Match filter (any subset
     *   of Conference fields) as an assoc-array; ConferenceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Conference[]|array A list of Conference items as assoc-arrays at
