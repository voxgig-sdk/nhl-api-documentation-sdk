...
// NhlApiDocumentation SDK Standing entity
...
class StandingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StandingEntity($this->_client, $opts);
    }

    /**
     * @param Standing|array $args Standing data (assoc-array) to store.
     */
    ...
    /**
     * @return Standing|array The current Standing data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Standing fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Standing fields).
     */
     ...
     *
     * @param StandingListMatch|array|null $reqmatch Match filter (any subset
     *   of Standing fields) as an assoc-array; StandingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Standing[]|array A list of Standing items as assoc-arrays at
