...
// NhlApiDocumentation SDK Roster entity
...
class RosterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RosterEntity($this->_client, $opts);
    }

    /**
     * @param Roster|array $args Roster data (assoc-array) to store.
     */
    ...
    /**
     * @return Roster|array The current Roster data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Roster fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Roster fields).
     */
    ...
    /**
     * List Roster items matching the given filter.
     *
     * @param RosterListMatch|array|null $reqmatch Match filter (any subset
     *   of Roster fields) as an assoc-array; RosterListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Roster[]|array A list of Roster items as assoc-arrays at
