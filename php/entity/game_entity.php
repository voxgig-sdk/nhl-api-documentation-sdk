...
// NhlApiDocumentation SDK Game entity
...
class GameEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GameEntity($this->_client, $opts);
    }

    /**
     * @param Game|array $args Game data (assoc-array) to store.
     */
    ...
    /**
     * @return Game|array The current Game data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Game fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Game fields).
     */
     ...
     * Load a single Game.
     *
     * @param GameLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GameLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Game|array The loaded Game as an assoc-array at the
