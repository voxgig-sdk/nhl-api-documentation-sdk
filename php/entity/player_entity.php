...
// NhlApiDocumentation SDK Player entity
...
class PlayerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PlayerEntity($this->_client, $opts);
    }

    /**
     * @param Player|array $args Player data (assoc-array) to store.
     */
    ...
    /**
     * @return Player|array The current Player data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Player fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Player fields).
     */
     ...
     *
     * @param PlayerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PlayerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Player|array The loaded Player as an assoc-array at the
