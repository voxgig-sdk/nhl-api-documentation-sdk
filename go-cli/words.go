...
func registerSDKWords(r *eng.Registry, client *sdk.NhlApiDocumentationSDK) {
...
func runOp(client *sdk.NhlApiDocumentationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
